...
The Slovene corpora was obtained from BSNLP and parts of newly published combined Training corpus {SUK} 1.0\cite{SUK-1.0}
...
Their corpora structure also influenced this decision, but nevertheless, we included them in the evaluation, to see if something interesting would emerge.
...
We can se that the average distance from the baseline is between 0.5\% and 1\%.
\begin{figure}[h]
